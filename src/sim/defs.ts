...
export const RESOURCE_INFO: Record<string, { from: string; used: string }> = {
  ...
  wheat: {
    from: 'Farmers sowing, hoeing and reaping the plots around a wheat farm.',
...
export const JOB_META: Record<JobId, { name: string; icon: string; desc: string }> = {
  ...
  farmer: { name: 'Farmer', icon: '🌱', desc: 'Sows, tends and harvests the wheat plots around the farm.' },
